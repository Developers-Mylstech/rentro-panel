  ...
  return (
    <div className="w-64 h-screen bg-primary shadow-md fixed p-5 overflow-y-auto z-20 ">
      ...
      <ul className="space-y-5 mt-10">
        ...
        <li>
          <Link to="/"
            className="flex items-center gap-3 p-2 text-secondary bg-primary hover:bg-secondary hover:text-primary rounded"
          >
          ...
          <li key={menu.name}>
            <button
              ...
              className={`flex items-center justify-between w-full p-2 rounded ${
                activeMenu === menu.name ? "bg-secondary text-primary" : "text-secondary bg-primary hover:bg-secondary hover:text-primary"
              }`}
            >
            ...
            {activeMenu === menu.name && (
              <ul className="pl-8 mt-2 space-y-1">
                <li>
                  <Link to={`/${menu.name}`} className="block p-2 text-gray-400 hover:text-secondary">
                    - All {menu.name.charAt(0).toUpperCase() + menu.name.slice(1)}
                  </Link>
                </li>
                {menu.name !== "orders" && (
                  <li>
                    <Link to={`/${menu.name}/add`} className="block p-2 text-gray-400 hover:text-secondary">
