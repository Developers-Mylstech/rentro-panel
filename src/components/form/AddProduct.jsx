...
//         <input
//           type="number"
//           className="w-full p-2 border-b bg-transparent rounded"
...
//             className="w-full p-2 border-b rounded bg-transparent"
...
//           />
//           <label htmlFor="Sell" className="text-green-600 text-sm">
//             Sell
//           </label>
//         </div>
...
//             className="border border-gray-300 dark:border-gray-600 rounded-md h-5 w-5"
//           />
//           <label htmlFor="Rent" className="text-orange-500 text-sm">
//             Rent
//           </label>
//         </div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-start w-full py-2 gap-2 ">
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-4 md:w-[70%] w-full relative">
          ...
          <div className="flex flex-col gap-2 pr-4 border-r-2 border-gray-200 dark:border-gray-600 relative">
            ...
            {visibleForm === "rent" && (
              <div className="absolute top-full md:left-0 -left-24 mt-2 z-10 bg-white dark:bg-gray-800 p-4 rounded-md shadow-lg w-80">
                <div className="flex flex-col gap-2">
                  {/* Price */}
                  <div className="flex flex-col">
                    <label
