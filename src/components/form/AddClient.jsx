...
//     if (files.length > 1) {
//       setMessage("Please select only one image for client");
//       return;
//     }
...
//       setPreviewUrls([]); // Clear preview after upload
...
//     const payload = {
//       name: data.name,
//       imageUrl: uploadedUrl[0], // send single image string not array
//     };
...
//   const displayImage = previewUrls.length > 0 ? previewUrls[0] : uploadedUrl[0];

//   console.log(displayImage,"this is image preview fr edit")
...
//                 <img
//                   src={displayImage}
//                   alt={isEditMode ? "Current client" : "Preview"}
...
//             {previewUrls.length > 0 && !uploadedUrl.length && (
//               <button
//                 type="button"
